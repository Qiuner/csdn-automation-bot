...
CHROME_BROWSER_PATH = r"C:\Users\Administrator\AppData\Local\Google\Chrome\Application\chrome.exe"
...
class CSDN:
    ...
    def start_browser(self):
        ...
        browserPath = os.path.join(self.curDir, CHROME_BROWSER_PATH).replace("\\", "/")
